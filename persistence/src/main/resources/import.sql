...
insert into user (id, user_name, password, enabled, role) values (1, 'admin', '$2a$10$aUHa71mxFxfZoTKy7s9MzuLToMXiJrFYe4EnRb.xFTP0f5SdH7r/2', 1, 'ROLE_ADMIN');
insert into user (id, user_name, password, enabled, role) values (2, 'user', '$2a$10$EXZplVAU9fBX2rtF9Y8ANePArB8AckMPVUbCUeVx5tFj8Dbphg5Py', 1, 'ROLE_USER');